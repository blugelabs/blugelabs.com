...
var searchURL = 'https://blugelabs.com/.netlify/functions/site-search'
...
$(document).ready(function () {
    ...
    var resultTmpl = Handlebars.compile($('#resultTmpl').html());
    Handlebars.registerPartial('resultTmpl', resultTmpl);
